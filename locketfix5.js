...
var NMS = {
    ...
    expires_date: "2027-11-25T10:10:14Z",
    grace_period_expires_date: null,
    refunded_at: null,
    unsubscribe_detected_at: null,
    original_purchase_date: "2027-11-25T10:10:15Z",
    purchase_date: "2027-11-25T10:10:14Z",
    store: "app_store",
...
if (match) {
    ...
    if (s) {
        ...
        obj.subscriber.subscriptions[s] = NMS;
    } else {
        obj.subscriber.subscriptions["locket_1600_1y"] = NMS;
    }
