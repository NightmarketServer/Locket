/***********************************************
 > Author: William - Thành Long
 > Rewrite by: NightmarketServer
***********************************************/
var request = $request;
const options = {
...
$httpClient.get(options, function(error, newResponse, data){
  ...
  let jsonToUpdate = {
    "request_date_ms": 1826816461000, // timestamp cho 25/11/2027
    "request_date": "2027-11-25T01:01:01Z",
    "subscriber": {
      "entitlement": {},
      "first_seen": "2027-11-25T01:01:01Z",
      "original_application_version": "9692",
      "last_seen": "2027-11-25T01:01:01Z",
      "other_purchases": {},
      "management_url": null,
      "subscriptions": {},
      "entitlements": {},
      "original_purchase_date": "2027-11-25T01:01:01Z",
  ...
  for (const [entitlementId, productInfo] of Object.entries(productEntitlementMapping)) {
    ...
    for (const entitlement of entitlements) {
      jsonToUpdate.subscriber.entitlements[entitlement] = {
        "purchase_date": "2027-11-25T01:01:01Z",
        "original_purchase_date": "2027-11-25T01:01:01Z",
